...
-- NOTE: The Order overlay has no main-menu button. The "Ruleset Reference"
-- button was removed from the main menu; the overlay itself (and all of its page
-- data + builders above) is kept intact and can be opened programmatically via
-- G.FUNCS.the_order_open should a mod want to surface it elsewhere.
